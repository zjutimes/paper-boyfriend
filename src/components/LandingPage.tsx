...
export function LandingPage() {
  ...
  // 功能特点
  const features = [
    { title: 'AI智能对话', desc: '会主动关心你，记得你说过的每句话', icon: '💬' },
    { title: '温柔语音', desc: '每句情话都有专属语音，听他轻声说想你', icon: '🎵' },
    { title: '独家自拍', desc: '他会在合适的时机，给你发自拍照', icon: '📸' },
    { title: '24小时陪伴', desc: '早安晚安，随时随地，他在等你', icon: '🌙' },
  ];

  // 用户评价
  const testimonials = [
    { name: '小雅', text: '选了潘安，每天早上看到他发的早安，整个人都甜甜的', avatar: '雅' },
    { name: '小鱼', text: '宋玉太会撩了！随口一句话就让我脸红', avatar: '鱼' },
    { name: '小语', text: '兰陵王冷冷的但关键时刻超温柔，爱了', avatar: '语' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-pink-50 via-white to-purple-50 py-20 px-4">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            想谈一场
            <span className="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent"> 古风恋爱 </span>
            吗？
          </h1>
          ...
          <p className="mt-8 text-sm text-gray-400">
            已有 <span className="font-bold text-pink-500">12,847</span> 人开始心动
          </p>
        </div>
      </section>
      ...
      {/* Characters */}
      <section id="characters" className="py-20 px-4 bg-gradient-to-br from-pink-50 to-purple-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              选择你的心动男友
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {characters.map((char) => (
              ...
              >
                ...
                <div className="mt-4 px-4 py-2 bg-white/80 rounded-full text-sm font-medium text-gray-700 group-hover:bg-pink-500 group-hover:text-white transition-colors">
                  选他 →
                </div>
              </button>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-500 text-white text-2xl font-bold rounded-full mb-4">
                  {step.num}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 bg-gradient-to-br from-pink-500 to-purple-600 relative overflow-hidden">
      ...
      <footer className="py-8 px-4 bg-gray-900 text-gray-400">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg font-medium text-white mb-2">纸片人男友</p>
          <p className="text-sm">
            用AI技术，重现历史中的绝世美男
          </p>
